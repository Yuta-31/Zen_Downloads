...
export const StringOperatorSchema = z.enum([
  "equals","notEquals","contains","notContains","startsWith","endsWith","matches","glob"
]);
...
export const RuleConditionSchema = z.union([StringConditionSchema, ArrayConditionSchema])

export const RuleActionSchema = z.object({
    pathTemplate: z.string().min(1),
    conflict: ConflictActionSchema.optional(),
    transfomrs: z.array(z.enum(["lower-ext", "upper-ext", "sanitize-file", "normalize-nfc"])).optional()
})
